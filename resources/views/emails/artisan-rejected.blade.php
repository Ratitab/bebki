...
<title>ოსტატის ანგარიში უარყოფილია</title>
</head>
    ...
    <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
            <td style="padding:36px 40px 8px 40px;text-align:center;">
                <div style="display:inline-block;width:64px;height:64px;background:linear-gradient(135deg,#fde8e8 0%,#fbd5d5 100%);border-radius:50%;line-height:64px;margin-bottom:16px;">
                    <span style="font-size:30px;">✕</span>
                </div>
                <h2 style="margin:0 0 10px 0;font-size:22px;font-weight:700;color:#1a1a1a;">
                    ოსტატის ანგარიში უარყოფილია
                </h2>
                <p style="margin:0;font-size:15px;line-height:1.65;color:#444444;">
                    სამწუხაროდ, თქვენი ოსტატის ანგარიშის მოთხოვნა ამჯერად ვერ დამტკიცდა.<br>
                    შეგიძლიათ განაახლოთ ინფორმაცია და წარადგინოთ ახალი მოთხოვნა.
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding:28px 40px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="background:#fff8f0;border:1px solid #fcd9a8;border-radius:14px;padding:24px;">
                            <div style="font-size:11px;font-weight:700;color:#92400e;text-transform:uppercase;letter-spacing:2px;margin-bottom:16px;">
                                შემდეგი ნაბიჯები
                            </div>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#92400e;font-size:14px;margin-right:8px;">①</span>
                                        <span style="font-size:14px;color:#444444;">გადახედეთ თქვენს პროფილს და შეავსეთ ყველა სავალდებულო ველი</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#92400e;font-size:14px;margin-right:8px;">②</span>
                                        <span style="font-size:14px;color:#444444;">დარწმუნდით, რომ ატვირთეთ ხარისხიანი ფოტოები</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#92400e;font-size:14px;margin-right:8px;">③</span>
                                        <span style="font-size:14px;color:#444444;">კითხვების შემთხვევაში დაგვიკავშირდით:
