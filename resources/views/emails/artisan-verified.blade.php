...
<title>ოსტატის ანგარიში დამტკიცებულია</title>
</head>
...
<table width="100%" cellapadding="0" cellspacing="0" style="background:#f4f1ec;">
<tr>
        ...
        <tr>
            <td style="padding:36px 40px 8px 40px;text-align:center;">
                ...
                <h2 style="margin:0 0 10px 0;font-size:22px;font-weight:700;color:#1a1a1a;">
                    ოსტატის ანგარიში დამტკიცებულია!
                </h2>
                <p style="margin:0;font-size:15px;line-height:1.65;color:#444444;">
                    გილოცავთ! თქვენი ოსტატის ანგარიში დადასტურებულია.<br>
                    ახლა შეგიძლიათ დაიწყოთ განცხადებების განთავსება და გაყიდვა Bebki.ge-ზე.
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding:28px 40px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="background:linear-gradient(180deg,#fdf8f8 0%,#f9f0f1 100%);border:1px solid rgba(132,44,54,0.15);border-radius:14px;padding:24px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#842c36;font-size:14px;margin-right:8px;">①</span>
                                        <span style="font-size:14px;color:#444444;">შეავსეთ მაღაზიის პროფილი და ატვირთეთ ლოგო</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#842c36;font-size:14px;margin-right:8px;">②</span>
                                        <span style="font-size:14px;color:#444444;">დაამატეთ თქვენი პირველი ნამუშევარი</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:6px 0;">
                                        <span style="color:#842c36;font-size:14px;margin-right:8px;">③</span>
                                        <span style="font-size:14px;color:#444444;">გაიგეთ მეტი შეკვეთებისა და გადახდების შესახებ</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
